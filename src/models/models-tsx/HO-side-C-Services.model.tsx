...
Command: npx gltfjsx@6.1.4 /Users/nzurashv/Desktop/work/tracercentral/resources/geo/HO-side-C-Services.glb --transform --t
*/
...
export function Model(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF("/HO-side-C-Services-transformed.glb") as GLTFResult;
  return (
...
useGLTF.preload("/HO-side-C-Services-transformed.glb");
