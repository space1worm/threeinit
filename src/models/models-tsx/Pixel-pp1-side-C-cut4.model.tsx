...
Command: npx gltfjsx@6.1.4 /Users/nzurashv/Desktop/work/tracercentral/resources/geo/pixel-pp1-side-C-cut4.glb --transform --t
*/
...
export function Model(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF("/pixel-pp1-side-C-cut4-transformed.glb") as GLTFResult;
  return (
...
useGLTF.preload("/pixel-pp1-side-C-cut4-transformed.glb");
