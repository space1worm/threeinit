 ...
 * @param props
 */
export function TileEndCapSideCCut3(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF(`${modelsUrl}/tile-end-cap-sidec-cut3.glb`) as GLTFResult;
  return (
